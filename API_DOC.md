...
- **默认降重强度**: `high`，采用高学术表达进行精修微调，严格保持句意不变，并在相似度偏高时最多自动精修 2 轮
...
8. `strength=high` 是“高学术精修微调”模式，优先保持句意、数字、术语、因果关系和结论强弱不变；相似度偏高时最多自动精修2轮
9. 服务会拦截提示词泄露内容，例如“必须进行深度改写”“改变句式结构”“rewritten_text”等规则文本，不会把这类内容作为正文直接返回；如果输入本身就是这类残留段落，会返回空正文，便于上游删除该段
10. 服务会对“具有重要意义”“综上所述”“可以看出”“表明”“说明”等高频论文套话增加惩罚，优先选择更自然的候选结果
